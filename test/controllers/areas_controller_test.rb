...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference("Area.count") do
      post areas_url, params: { area: { airbnb_place_id: @area.airbnb_place_id, city: @area.city, state_id: @area.state_id } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { airbnb_place_id: @area.airbnb_place_id, city: @area.city, state_id: @area.state_id } }
